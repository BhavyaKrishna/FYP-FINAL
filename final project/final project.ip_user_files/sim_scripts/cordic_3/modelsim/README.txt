...
#
# Generated by export_simulation on Thu Apr 30 16:29:41 +0530 2020
#
################################################################################
...
'-reset_run' switch to the './cordic_3.sh' script.

./cordic_3.sh -reset_run
...
./cordic_3.sh -noclean_files

For more information on the script, please type './cordic_3.sh -help'.
