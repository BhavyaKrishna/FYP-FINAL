...
HD_PWD='F:/FYP-FINAL/final project/final project.runs/cordic_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_3.tcl
